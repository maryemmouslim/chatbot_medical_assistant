...
def repondre(question, session_id="default"):
    ...
    for echange in get_historique(session_id):
        messages.append(HumanMessage(content=echange["question"]))
        messages.append(AIMessage(content=echange["reponse"]))
